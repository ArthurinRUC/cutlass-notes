...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("pipelining_fp16_fp16_fp16_fp16", &(run_pipelining<128, 128, 64, 5, cute::half_t, cute::half_t, cute::half_t>), "Run a mixed-precision half 16x8x8 MMA operation.");
  m.def("pipelining_fp16_fp16_fp16_fp32", &(run_pipelining<128, 128, 64, 5, cute::half_t, cute::half_t, cute::half_t, float>), "Run a mixed-precision half 16x8x8 MMA operation.");
  m.def("pipelining_bf16_bf16_bf16_fp32", &(run_pipelining<128, 128, 64, 5, cute::bfloat16_t, cute::bfloat16_t, cute::bfloat16_t, float>), "Run a mixed-precision half 16x8x8 MMA operation.");
}
