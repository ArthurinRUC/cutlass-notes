...
dynamic_mma(void* __restrict__ Cptr,
...
torch::Tensor
run_dynamic_mma(const torch::Tensor a, const torch::Tensor b, std::optional<torch::Tensor> _c) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("dynamic_mma_fp16_fp16_fp16_fp16", &(run_dynamic_mma<128, 128, 64, cute::half_t, cute::half_t, cute::half_t>), "Run a mixed-precision half 16x8x8 MMA operation.");
  m.def("dynamic_mma_fp16_fp16_fp16_fp32", &(run_dynamic_mma<128, 128, 64, cute::half_t, cute::half_t, cute::half_t, float>), "Run a mixed-precision half 16x8x8 MMA operation.");
  m.def("dynamic_mma_bf16_bf16_bf16_fp32", &(run_dynamic_mma<128, 128, 64, cute::bfloat16_t, cute::bfloat16_t, cute::bfloat16_t, float>), "Run a mixed-precision half 16x8x8 MMA operation.");
}
